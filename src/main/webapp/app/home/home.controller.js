(function() {
    ...
    HomeController.$inject = ['$scope', 'Principal', 'LoginService', '$state', 'FeedItem', 'SocialFollow', 'ParseLinks'
    	, 'AlertService', 'paginationConstants', 'pagingParams', 'FeedItemDetailDialogService'];

    function HomeController ($scope, Principal, LoginService, $state, FeedItem, SocialFollow, ParseLinks
    		, AlertService, paginationConstants, pagingParams, FeedItemDetailDialogService) {
        var vm = this;
