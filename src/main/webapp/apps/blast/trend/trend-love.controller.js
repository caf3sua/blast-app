...
(function() {
    ...
    angular
      .module('app')
      .controller('TrendLoveController', TrendLoveController);
    
    TrendLoveController.$inject = ['$controller', '$scope', 'Keyword', 'FeedItem'];

      function TrendLoveController($controller, $scope, Keyword, FeedItem){
    	  		var vm = this;
